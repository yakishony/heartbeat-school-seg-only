...
from env import DATA_FOR_ML, FIGURES_DIR, RATE_DS, CATEGORY_NAMES
from ML import load_all_ids, VAL_SPLIT
from utils.plot_utils import LABEL_COLORS, LABEL_NAMES

CHECKPOINT = "checkpoints/downsampled_4x_reduced_overfit_model2/epoch_028.keras"
N_SAMPLES = 5
SEED = 7
...
def plot_confusion_matrix(model, batch_size=128):
    ...
    ConfusionMatrixDisplay(cm, display_labels=CATEGORY_NAMES).plot(ax=ax1, cmap="Blues", colorbar=False)
    ...
    fig.suptitle("Confusion Matrix — All Data", fontsize=13)
    fig.tight_layout()

    out = FIGURES_DIR / "fig_confusion_matrix.png"
